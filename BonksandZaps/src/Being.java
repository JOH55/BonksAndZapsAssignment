/**
 * Represents an inhabitant of GridWorld * @author cwl
 * 
 * @version 1.0
 */
public interface Being {
	 ...
	 * creation. It is fixed, but can be discovered via this method * @return
	 * The name
	 */
	...
	/**
	 * Allows the relocation of the Being to another Room in Grid World * @param
	 * location
	 */
